# How to run the Moore_Penrose_structural_check_IRIO.py


from Moore_Penrose_structural_check_IRIO import *
...
df_export_adj.to_excel('example outputs/hasil cek error IRIO adj Moore-Penrose.xlsx')
df_cek_error = pd.DataFrame(cek_error)
df_cek_error.to_excel('example outputs/hasil cek error IRIO Indonesia Moore-Penrose.xlsx')
